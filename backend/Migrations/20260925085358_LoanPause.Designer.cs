...
namespace AltomateHR.Api.Migrations
{
    ...
    [Migration("20260925085358_LoanPause")]
    partial class LoanPause
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Attendance.Entities.AttendanceRecord", b =>
                {
                    ...
                    b.Property<bool?>("ClockInIpAllowed")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Claims.Entities.Claim", b =>
                {
                    ...
                    b.Property<string>("ReceiptXeroFileId")
                        .HasMaxLength(80)
                        .HasColumnType("varchar(80)");
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Payroll.Entities.EmployeeLoan", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<int?>("PausedFromMonth")
                        .HasColumnType("int");

                    b.Property<int?>("PausedFromYear")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Payroll.Entities.PayrollPortalCredential", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("OrganizationId", "Portal")
                        .IsUnique();

                    b.ToTable("PayrollPortalCredentials");
                });
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Payroll.Entities.PayrollRunMember", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Payroll.Entities.Payslip", b =>
                {
                    ...
                    b.Property<decimal>("VoluntaryPcb")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)");
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Payroll.Entities.SalaryChange", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<string>("NewSalaryType")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)");
                    ...
                    b.Property<string>("PreviousSalaryType")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)");
                    ...
                    b.HasIndex("EmployeeProfileId", "EffectiveDate");
            ...
            modelBuilder.Entity("AltomateHR.Api.Modules.Projects.Entities.ProjectAllowedIp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("ProjectAllowedIps");
                });

            modelBuilder.Entity("AltomateHR.Api.Modules.Projects.Entities.ProjectGeofencePoint", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("ProjectGeofencePoints");
                });

            modelBuilder.Entity("AltomateHR.Api.Modules.Projects.Entities.ProjectManager", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
