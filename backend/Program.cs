...
builder.Services.AddSingleton<AltomateHR.Api.Common.ISecretBox, AltomateHR.Api.Common.SecretBox>();
builder.Services.AddScoped<AltomateHR.Api.Modules.Payroll.Cron.IPastLeaverArchiver,
    AltomateHR.Api.Modules.Payroll.Cron.PastLeaverArchiver>();
builder.Services.AddHostedService<AltomateHR.Api.Modules.Payroll.Cron.ArchivePastLeaversBackgroundService>();
builder.Services.AddScoped<IPayrollEmployeeImportService, PayrollEmployeeImportService>();
builder.Services.AddScoped<IPayrollEmployeeDirectoryService, PayrollEmployeeDirectoryService>();
builder.Services.AddScoped<IYtdImportService, YtdImportService>();
builder.Services.AddScoped<IPortalCredentialRepository, PortalCredentialRepository>();
...
builder.Services.AddScoped<IPayrollXeroSyncService, PayrollXeroSyncService>();
...
builder.Services.AddScoped<ITeamApprovalOverrideRepository, TeamApprovalOverrideRepository>();
...
builder.Services.AddScoped<IProjectTrackingScope, ProjectTrackingScope>();
