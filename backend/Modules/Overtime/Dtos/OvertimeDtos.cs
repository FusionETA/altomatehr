...
// One reviewer's pending-overtime count, org-wide (every org, since the
// caller — Modules/Approvals/ApprovalDigestService — runs with no request
// context and spans every tenant). Mirrors Attendance's
// OrgApprovalDigestEntryDto; kept as Overtime's own copy rather than a shared
// type, matching how each module already owns its own status enum.
